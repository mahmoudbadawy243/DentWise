...
function AppointmentConfirmationEmail({
  doctorName, appointmentDate, appointmentTime, appointmentType, duration, price }: AppointmentConfirmationEmailProps) {
        ...
        <Container style={container}>
          <Section style={logoContainer}>
            <Img
              ...
              width="50" height="50" alt="DentWise" style={logo}
            />
            <Text style={logoText}>DentWise</Text>
          </Section>

          <Heading style={h1}>Appointment Confirmed 🦷</Heading>
          <Heading style={h1}>Coded By Mahmoud Badawy</Heading>
          ...
          <Section style={buttonContainer}>
            {/* i use this link only in develop but when deploy it should like "demo-name/appointments.com" */}
...
// I used AI to create this styles
