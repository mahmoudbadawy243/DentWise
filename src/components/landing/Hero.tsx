        ...
        <div className="max-w-7xl mx-auto text-center md:text-left">
          <div className="grid lg:grid-cols-2 gap-20 items-center pb-10">
            ...
            <div className="space-y-10">
              ...
              {/* CTA BUTTONS */}
              <div className="flex flex-col sm:flex-row gap-4 px-10 md:px-0">
            ...
            <div className="relative lg:pl-8">
              {/* GRADIENT ORBS */}
              <div className="absolute -top-4 -left-[-6] w-24 h-24 bg-linear-to-br from-primary/20 to-primary/10 rounded-2xl rotate-45 blur-xl"></div>
